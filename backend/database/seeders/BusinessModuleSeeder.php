...
class BusinessModuleSeeder extends Seeder
{
    public function run(): void
    {
        $modules = [
            ...
            ['slug' => 'shop', 'name' => 'EOKE Sports', 'description' => 'E-commerce for sports equipment', 'sort_order' => 2],
            ['slug' => 'tours', 'name' => 'EVOKE Tours', 'description' => 'Travel packages and bookings', 'sort_order' => 3],
