...
class PageSectionController extends Controller
{
    public function store(Request $request, int $pageId): JsonResponse
    {
        $validated = $request->validate([
            'component_type' => 'required|string|in:banner,text,gallery,faq,video,cards,testimonials,map,forms',
    ...
    public function update(Request $request, int $pageId, PageSection $section): JsonResponse
    {
        ...
        $validated = $request->validate([
            'component_type' => 'sometimes|string|in:banner,text,gallery,faq,video,cards,testimonials,map,forms',
