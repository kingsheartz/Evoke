...
export function FirebaseGoogleSignInButton({
  ...
  return (
    <Button type="button" variant="outline" className="w-full" disabled={disabled || busy} onClick={handleClick}>
      <GoogleIcon />
  ...
  return (
    <div className="relative py-1">
      ...
      <div className="relative flex justify-center text-xs uppercase tracking-wide">
        <span className="bg-transparent px-2 text-app-muted">or</span>
      </div>
    </div>
  );
}
